-- Minimal Postgres setup for asset-discovery cache tables.
...
ALTER TABLE discovered_urls
ADD COLUMN IF NOT EXISTS wait_for TEXT;
ALTER TABLE discovered_urls
ADD COLUMN IF NOT EXISTS js_code TEXT;
ALTER TABLE discovered_urls
ADD COLUMN IF NOT EXISTS scan_full_page BOOLEAN DEFAULT FALSE;
ALTER TABLE discovered_urls
ADD COLUMN IF NOT EXISTS screenshot BOOLEAN DEFAULT FALSE;
END $$;
